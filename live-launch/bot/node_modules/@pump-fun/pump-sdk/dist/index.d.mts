...
interface CollectCoinCreatorFeeEventAmm {
    timestamp: BN;
...
declare function newBondingCurve(global: Global, quoteMint?: PublicKey): BondingCurve;
declare function getBuyTokenAmountFromSolAmount({ global, feeConfig, mintSupply, bondingCurve, amount, quoteMint, }: {
    global: Global;
...
declare function getBuySolAmountFromTokenAmount({ global, feeConfig, mintSupply, bondingCurve, amount, quoteMint, }: {
    global: Global;
    feeConfig: FeeConfig | null;
    mintSupply: BN | null;
    bondingCurve: BondingCurve | null;
...
declare function bondingCurveMarketCap({ mintSupply, virtualQuoteReserves, virtualTokenReserves, }: {
    mintSupply: BN;
    virtualQuoteReserves: BN;
    virtualTokenReserves: BN;
}): BN;
...
declare const FEE_PROGRAM_GLOBAL_PDA: PublicKey;
...
declare const isLegacyQuoteMint: (quoteMint: PublicKey) => boolean;
declare const quoteAta: (owner: PublicKey, quoteMint: PublicKey, quoteTokenProgram: PublicKey) => PublicKey;
 ...
 */
declare const donationFeePda: (mint: PublicKey, configId: PublicKey) => PublicKey;
declare const DONATION_RELAY_PROGRAM_ID_MAINNET: PublicKey;
declare const DONATION_RELAY_PROGRAM_ID_DEVNET: PublicKey;
declare const donationRelayPda: (seeds: (Buffer$1 | Uint8Array)[], donationRelayProgramId: PublicKey) => PublicKey;
/**
 * Donation Relay epoch tracker PDA — accumulates per-`(configId, quoteMint)`
 * epoch state.
 */
declare const donationRelayEpochTrackerPda: (configId: PublicKey, quoteMint: PublicKey, donationRelayProgramId: PublicKey) => PublicKey;
/**
 * Donation Relay debouncer PDA — token escrow that accumulates per-`(configId,
 * quoteMint)` deposits between epoch closures.
 */
declare const donationRelayDebouncerPda: (configId: PublicKey, quoteMint: PublicKey, donationRelayProgramId: PublicKey) => PublicKey;
...
declare class PumpSdk {
    ...
    getCoinCreatorVaultQuoteMint(coinCreator: PublicKey, coinCreatorVaultAta: PublicKey): PublicKey | null;
    ...
    decodeSocialFeePda(accountInfo: AccountInfo<Buffer>): SocialFeePda;
    ...
    decodeCollectCoinCreatorFeeEventAmm(data: Buffer): CollectCoinCreatorFeeEventAmm;
    decodeDonationFeePda(accountInfo: AccountInfo<Buffer>): DonationFeePda;
    /**
    ...
    createV2Instruction({ mint, name, symbol, uri, creator, user, mayhemMode, cashback, quoteMint, }: {
        mint: PublicKey;
        name: string;
        symbol: string;
        uri: string;
    ...
    createV2AndBuyInstructions({ global, mint, name, symbol, uri, creator, user, amount, solAmount, mayhemMode, cashback, isTokenizedAgent, buyBackBps, }: {
        global: Global;
        mint: PublicKey;
        name: string;
        symbol: string;
     ...
     */
    createAndBuyInstructions({ global, mint, name, symbol, uri, creator, user, amount, solAmount, isTokenizedAgent, buyBackBps, }: {
        global: Global;
        mint: PublicKey;
        name: string;
        symbol: string;
    ...
    migrateV2Instruction({ withdrawAuthority, mint, user, quoteMint, baseTokenProgram, quoteTokenProgram, }: {
        withdrawAuthority: PublicKey;
        mint: PublicKey;
        user: PublicKey;
        quoteMint: PublicKey;
    ...
    getBuyInstructionRaw({ user, mint, creator, amount, solAmount, feeRecipient, tokenProgram, buybackFeeRecipient, }: {
        user: PublicKey;
        mint: PublicKey;
        creator: PublicKey;
        amount: BN;
    ...
    getSellInstructionRaw({ user, mint, creator, amount, solAmount, feeRecipient, buybackFeeRecipient, tokenProgram, cashback, }: {
        user: PublicKey;
        mint: PublicKey;
        creator: PublicKey;
        amount: BN;
    ...
    buyV2Instructions({ global, bondingCurveAccountInfo, bondingCurve, associatedUserAccountInfo, mint, user, amount, quoteAmount, slippage, tokenProgram, quoteTokenProgram, }: {
        global: Global;
        bondingCurveAccountInfo: AccountInfo<Buffer>;
        bondingCurve: BondingCurve;
        associatedUserAccountInfo: AccountInfo<Buffer> | null;
    ...
    createV2AndBuyV2Instructions({ global, mint, name, symbol, uri, creator, user, amount, quoteAmount, mayhemMode, cashback, quoteMint, quoteTokenProgram, }: {
        global: Global;
        mint: PublicKey;
        name: string;
        symbol: string;
    ...
    getBuyV2InstructionRaw({ user, mint, creator, amount, quoteAmount, feeRecipient, buybackFeeRecipient, tokenProgram, quoteMint, quoteTokenProgram, }: {
        user: PublicKey;
        mint: PublicKey;
        creator: PublicKey;
        amount: BN;
    ...
    private getBuyV2InstructionInternal;
    getSellV2InstructionRaw({ user, mint, creator, amount, quoteAmount, feeRecipient, buybackFeeRecipient, tokenProgram, quoteMint, quoteTokenProgram, }: {
        user: PublicKey;
        mint: PublicKey;
        creator: PublicKey;
        amount: BN;
    ...
    private getSellV2InstructionInternal;
    /**
     ...
     * ```
     */
    updateFeeSharesV2({ authority, mint, currentShareholders, newShareholders, quoteMint, quoteTokenProgram, }: {
        authority: PublicKey;
        mint: PublicKey;
        currentShareholders: PublicKey[];
        newShareholders: Shareholder[];
     ...
     */
    transferCreatorFeesToPumpV2({ payer, mint, quoteMint, quoteTokenProgram, }: {
        payer: PublicKey;
        mint: PublicKey;
        quoteMint: PublicKey;
        quoteTokenProgram: PublicKey;
    ...
    distributeCreatorFeesV2({ mint, sharingConfig, sharingConfigAddress, quoteMint, payer, shouldInitializeAta, quoteTokenProgram, }: {
        mint: PublicKey;
        sharingConfig: SharingConfig;
        sharingConfigAddress: PublicKey;
        quoteMint: PublicKey;
     ...
     */
    createDonationFeePda({ coinCreator, mint, configId, }: {
        coinCreator: PublicKey;
        mint: PublicKey;
        configId: PublicKey;
    }): Promise<TransactionInstruction>;
     ...
     */
    crankDonationFeePda({ payer, mint, configId, donationRelayProgramId, quoteMint, }: {
        payer: PublicKey;
        mint: PublicKey;
        configId: PublicKey;
    ...
    claimSocialFeePda({ recipient, socialClaimAuthority, userId, platform, }: {
        recipient: PublicKey;
        socialClaimAuthority: PublicKey;
        userId: string;
        platform: number;
    ...
    claimCashbackV2Instruction({ user, quoteMint, quoteTokenProgram, }: {
        user: PublicKey;
        quoteMint?: PublicKey;
        quoteTokenProgram?: PublicKey;
    }): Promise<TransactionInstruction>;
...
declare class OnlinePumpSdk {
    ...
    collectCoinCreatorFeeV2Instructions(coinCreator: PublicKey, quoteMint: PublicKey, quoteTokenProgram: PublicKey, feePayer?: PublicKey): Promise<TransactionInstruction[]>;
...
export { AMM_GLOBAL_PDA, AMM_GLOBAL_VOLUME_ACCUMULATOR_PDA, BONDING_CURVE_NEW_SIZE, type BondingCurve, CANONICAL_POOL_INDEX, type CollectCoinCreatorFeeEventAmm, type CollectCreatorFeeEvent, DONATION_RELAY_PROGRAM_ID_DEVNET, DONATION_RELAY_PROGRAM_ID_MAINNET, type DistributeCreatorFeeResult, type DistributeCreatorFeesEvent, type DonationFeePda, DuplicateShareholderError, FEE_PROGRAM_GLOBAL_PDA, type FeeConfig, GLOBAL_PDA, GLOBAL_VOLUME_ACCUMULATOR_PDA, type Global, type GlobalVolumeAccumulator, InvalidShareTotalError, MAYHEM_PROGRAM_ID, type MinimumDistributableFeeEvent, type MinimumDistributableFeeResult, NoShareholdersError, OnlinePumpSdk, PUMP_AMM_EVENT_AUTHORITY_PDA, PUMP_AMM_PROGRAM_ID, PUMP_EVENT_AUTHORITY_PDA, PUMP_FEE_CONFIG_PDA, PUMP_FEE_EVENT_AUTHORITY_PDA, PUMP_FEE_PROGRAM_ID, PUMP_PROGRAM_ID, PUMP_SDK, Platform, PoolRequiredForGraduatedError, type Pump, type PumpFees, PumpSdk, ShareCalculationOverflowError, type Shareholder, type SharingConfig, type SocialFeePda, type SocialFeePdaClaimedEvent, type SocialFeePdaCreatedEvent, TooManyShareholdersError, type UserVolumeAccumulator, type UserVolumeAccumulatorTotalStats, ZeroShareError, ammCreatorVaultPda, bondingCurveMarketCap, bondingCurvePda, bondingCurveV2Pda, canonicalPumpPoolPda, canonicalPumpPoolPdaWithQuote, creatorVaultPda, currentDayTokens, donationFeePda, donationRelayDebouncerPda, donationRelayEpochTrackerPda, donationRelayEventAuthorityPda, donationRelayMintWhitelistPda, donationRelayPda, feeSharingConfigPda, getBuySolAmountFromTokenAmount, getBuyTokenAmountFromSolAmount, getEventAuthorityPda, getGlobalParamsPda, getMayhemStatePda, getPumpAmmProgram, getPumpFeeProgram, getPumpProgram, getSellSolAmountFromTokenAmount, getSolVaultPda, getTokenVaultPda, hasCoinCreatorMigratedToSharingConfig, isLegacyQuoteMint, isSharingConfigEditable, newBondingCurve, platformToString, pump as pumpIdl, pumpPoolAuthorityPda, quoteAta, socialFeePda, stringToPlatform, totalUnclaimedTokens, userVolumeAccumulatorPda };
