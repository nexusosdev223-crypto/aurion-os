...
var PumpAmmSdk = class {
  ...
  async buyInstructionsNoPool(swapSolanaState, baseOut, maxQuoteIn) {
    ...
    return this.withWsolAccount(
      ...
      async () => {
        ...
        if (!pool.coinCreator.equals(import_web34.PublicKey.default)) {
          remainingAccounts.push({
            pubkey: poolV2PdaKey,
            isWritable: false,
            isSigner: false
  ...
  async sellInstructionsNoPool(swapSolanaState, baseAmountIn, minQuoteAmountOut) {
    ...
    return this.withWsolAccount(
      ...
      async () => {
        ...
        instructions.push(
          await this.offlineProgram.methods.sell(baseAmountIn, minQuoteAmountOut).accounts(swapAccounts).remainingAccounts([...remainingAccounts]).instruction()
        );
        if (quoteMint.equals(import_spl_token3.NATIVE_MINT)) {
          instructions.push(
            (0, import_spl_token3.createCloseAccountInstruction)(
  ...
  swapAccounts(swapSolanaState) {
    ...
    return {
      ...
      buybackFeeRecipient,
      buybackFeeRecipientTokenAccount: (0, import_spl_token3.getAssociatedTokenAddressSync)(
        quoteMint,
        buybackFeeRecipient,
        true,
        quoteTokenProgram
